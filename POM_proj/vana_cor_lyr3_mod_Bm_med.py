...
def create_plot(run_numbers, start_stop_time, fill_range, options={}):
	...
	like '%BPix_Bm%_%%%%_LYR3_%%%%%_MOD1%' order by t1.calib_timestamp
	...
	table2 = """
        ...
        inner join cms_tom.cms_pix_calib_readbacker t4 on t4.part_id=t2.part_id
        and t4.run_id=t2.run_id where t1.calib_type_id=1 and t3.name
        like '%BPix_Bm%_%%%%_LYR3_%%%%%_MOD2%' order by t1.calib_timestamp
	...
	table3 = """
        ...
        inner join cms_tom.cms_pix_calib_readbacker t4 on t4.part_id=t2.part_id
        and t4.run_id=t2.run_id where t1.calib_type_id=1 and t3.name
        like '%BPix_Bm%_%%%%_LYR3_%%%%%_MOD3%' order by t1.calib_timestamp
	...
	table4 = """
        ...
        inner join cms_tom.cms_pix_calib_readbacker t4 on t4.part_id=t2.part_id
        and t4.run_id=t2.run_id where t1.calib_type_id=1 and t3.name
        like '%BPix_Bm%_%%%%_LYR3_%%%%%_MOD4%' order by t1.calib_timestamp
	...
	if graph_type == "normal":
		...
		new_plot.xaxis_title="Time"
        	new_plot.yaxis_title="Median VANA [v] for LYR3"
