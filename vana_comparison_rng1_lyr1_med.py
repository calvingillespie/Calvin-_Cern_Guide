...
def create_plot(run_numbers, start_stop_time, fill_range, options={}):
	...
	where t3.name like 'FPix_%%%_%%_%%%%_%%%%_RNG1_%%%%' order by t1.calib_timestamp
	"""  
        ...
        like '%BPix_Bm%_%%%%_LYR1_%%%%%_MOD%%' order by t1.calib_timestamp
        """
	...
	if graph_type == "normal":
		...
		new_plot.yaxis_title="Median VANA [v] for RNG1 FPIX and LYR1 BPIX"
