...
To connect to LXPLUS : ssh username@lxplus.cern.ch

To connect to CMS servers from LXPLUS : ssh username@cmsusr.cern.ch

To connect to TOM server from CMS : ssh username@tom.cms

To connect local host to CMS by using LXPLUS as a proxy : ssh -L 8058:tom.cms:8058 -J username@lxplus.cern.ch username@cmsusr.cern.ch
